<main class="container">
  ...
  <div class="row g-5 mt-2">
    <div class="col-md-8">
      <div class="mb-5">
        <h3 class="pb-4 mb-4 fst-italic border-bottom">Kabar Pesantren</h3>
      ...
      <div class="mb-5">
        <h3 class="pb-4 mb-4 fst-italic border-bottom">Kajian Islami</h3>
        <div class="row mb-2 gap-4">
          <div class="col-md-12">
            <a href="">
              <div class="card">
      ...
      <div class="mb-5">
        <h3 class="pb-4 mb-4 fst-italic border-bottom">Cerita Islami</h3>
        <div class="row mb-2 gap-4">
          <div class="col-md-12">
            <a href="">
              <div class="card">
